...
The FPGA can be configured using Lattice Semiconductor's iCEcube2 Design Software and Diamond Programmer. iCEcube2 is used to generate the bitstreams, while Diamond Programmer is used to flash the bitstreams on to the FPGA.
% TODO: Add link to documentation on how this is done
