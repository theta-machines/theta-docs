...
import T0InstructionFormats from "./draw.io/t0-instruction-formats.svg";
import T0InstructionMnemonics from "./draw.io/t0-instruction-mnemonics.svg";
import StepSignal from "./draw.io/step-signal.svg";

:::info
The T0 ISA is for research and development. It is not intended to define a fully functional machine controller.
:::
...
<T0InstructionFormats className="img-center"/>
<br/>
...
<T0InstructionMnemonics className="img-center"/>
<br/>
...
## Example Program
:::info
Whenever setting global parameters, there must be an `update` instruction before any subsequent `setpos` instructions. This is shown in line 6 of the example program below.
:::
...
# Motion
setpos x 0              # 50 00 00 00 00
setpos y 0              # 51 00 00 00 00
setpos z 0              # 52 00 00 00 00
update                  # 00
...
This program moves all axes to a position of 0 steps, then increases their position by one step each update period. The program stops once all axes have been given a target position of 3 steps.
